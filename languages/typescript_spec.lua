...
describe("languages.typescript", function()
    local typescript_coverage = function(bufname)
        local lines = {
    ...
    it("places signs", function()
        vim.api.nvim_set_current_dir("languages/typescript/")
        vim.cmd("edit src/fizzbuzz.ts")
        ...
        local expected = typescript_coverage(bufname)
