...
describe("languages.cpp", function()
    local cpp_coverage = function(bufname)
        local lines = {
    ...
    it("places signs", function()
        vim.api.nvim_set_current_dir("languages/cpp/")
        vim.cmd("edit src/example.cpp")
        ...
        local expected = cpp_coverage(bufname)
